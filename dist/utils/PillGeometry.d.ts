 ...
 */
export declare function createPillNormalMap(width: number, height: number, expansion: number, bevel: number, shape: SurfaceShape, flipX?: boolean, flipY?: boolean): Texture;
